...
class Api2clientsService extends __BaseService {
  static readonly findAllPath = '/api2/clients';
  static readonly deletePath = '/api2/clients/{id}';
...
module Api2clientsService {
}

export { Api2clientsService }
