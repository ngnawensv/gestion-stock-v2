...
class Api2authenticateService extends __BaseService {
  static readonly authenticatePath = '/api2/authenticate';
  ...
  authenticateResponse(body?: AuthenticationRequest): __Observable<__StrictHttpResponse<AuthenticationResponse>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/api2/authenticate`,
      __body,
      {
        headers: __headers,
        params: __params,
...
module Api2authenticateService {
}

export { Api2authenticateService }
